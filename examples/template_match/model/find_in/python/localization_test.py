...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Template Match Demo')
    ...
    for i in range(test_num):
        ...
        output = net.forward()
        softmax_prob = output['softmax_prob'][0]
        label = False
        ...
        visualizePair(template_origin_img, search_origin_img, softmax_prob[1], save_path)

        # input = raw_input('q for quit: ')
        # if input == 'q':
        #     break
        # else:
        #     plt.close(0)
