#ifndef CAFFE_SIGMOID_CROSS_ENTROPY_LOSS_MINING_LAYER_HPP_
#define CAFFE_SIGMOID_CROSS_ENTROPY_LOSS_MINING_LAYER_HPP_
...
class SigmoidCrossEntropyLossMiningLayer : public LossLayer<Dtype> {
 public:
  explicit SigmoidCrossEntropyLossMiningLayer(const LayerParameter& param)
 ...
 protected:
  /// @copydoc SigmoidCrossEntropyLossMiningLayer
